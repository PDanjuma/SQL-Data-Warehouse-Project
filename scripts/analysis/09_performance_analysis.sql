...
Script Purpose:
	This script analyzes product performance by comparing current year sales
	to average sales and previous year sales to identify trends.

Usage:
	- Compare each product's current sales to its overall average
	- Identify products performing above or below average per year.
